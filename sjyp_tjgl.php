...
<div class="fuceng">
  <div class="fuqu">
    <div class="fuquzone">
      ...
      <div class="fuqubiao">
        <p><span>策略名称</span><input type="text"></p>
          <p><span class="tiaoshijian">响应开始时间：</span>
        <input type="text" class="shi" id="xuanshi1" readonly value="2016-10-10">
        ...
        <i class="glyphicon glyphicon-calendar fa fa-calendar"></i></p> 
        <p><span>目标负荷：</span><input type="text"></p>
        <p style="overflow:hidden"><span>是否可用：</span>
          <span class="rad">
                  <label for="keyong">可用</label>
                  <input type="radio" name="kf" id="keyong" checked="checked" />
             </span>    <span class="rad"> 
                  <label for="bukeyong">不可用</label>
                  <input type="radio" name="kf" id="bukeyong"  />
          </span>
          </p>
          <p style="height:80px;"><span>策略解析:</span><textarea name="" id="" cols="10" rows="10"></textarea></p>
      </div>
<div class="fucelue">
...
<div class="fuquqieneit">
        <div class="fuquqiejut">
          ...
          <div class="fuqutable">
            ...
            <li><span>策略1</span><span>1000KW</span><span>启停</span><span><img src="vince/images/icon_27.png" alt=""></span></li>
            <li><span>策略2</span><span>1000KW</span><span>变频</span><span><img src="vince/images/icon_27.png" alt=""></span></li>
          </div>
        </div>
        <div class="fuquqiejut">
          <p>未控制设备列表</p>
  ...
  <div class="content-wrapper">
    ...
    <div class="yjgl">
                ...
                <div class="sbaz_table">
                  <p><span class="float_left"><span>策略名称：</span><input type="text"></span>
...
<table class="tj_table" border="0">
  ...
  <tbody>
    <tr><td>01夏季空调调频策略</td><td>5000KW</td><td>调高空调出水温度5℃，降低冷却泵点击频率。</td><td> <a href="#" class="lindianjia">修改</a> | <a href="#">删除</a></td></tr>
    <tr><td>02照明控制策略</td><td>2000KW</td><td>根据室内亮度，调节LED灯亮度及功率。</td><td> <a href="#" class="lindianjia">修改</a> | <a href="#">删除</a></td></tr>
    <tr><td>02插座控制策略</td><td>2000KW</td><td>根据工作时间安排，节约非工作时间插座功率。</td><td> <a href="#" class="lindianjia">修改</a> | <a href="#">删除</a></td></tr>
    <tr><td colspan="8" class="text_al_rig lindianjia"> <input type="submit" value="添加策略" class="anniu lindianjia"></td></tr>
    <tr></tr>
  ...
  <div class="t_fanye">
    ...
    <div class="clear"></div>
  </div></div><div class="cheng_ershi"></div></div></div></div></div></div></div>
